...
const en: Dict = {
  ...
  "settings.hosts.help":
    "Manage stacks on another machine from here. Mint a token, then run the shown command on that host — it dials home over one outbound WebSocket (no inbound port, no Docker socket on the wire). The host then appears in the Stacks host switcher.",
  "settings.hosts.mint": "Add a host",
  "settings.hosts.regenerate": "Regenerate token",
  "settings.hosts.revoke": "Revoke",
  "settings.hosts.revoked": "Agent token revoked.",
  "settings.hosts.active": "Enrollment is enabled.",
  "settings.hosts.none": "No agent token yet.",
  "settings.hosts.copyNow": "Copy the token now — it won't be shown again.",
  "settings.hosts.nameLabel": "Host name",
  "settings.hosts.runOn": "Run this on the host you want to add:",
  "settings.hosts.copyCmd": "Copy command",
  ...
  "settings.git.remoteTitle": "Git remote",
  "settings.git.pull": "Pull",
  "settings.git.pulling": "Pulling…",
  "settings.git.pullDesc":
    "Fast-forward the stacks directory from its remote (pull-only). Changed stacks show as drifted — redeploy them to apply.",
  "settings.git.pullFailed": "Pull failed.",
  ...
  "stacks.new": "New",
  "stacks.blank": "Blank",
  "stacks.fromRun": "From docker run",
  "stacks.runPlaceholder": "Paste a docker run … command",
  "stacks.runPreview": "Generated compose.yaml",
  ...
  "stacks.logs": "Logs",
  "stacks.operation": "Operation",
  "stacks.opRunning": "Running — output in the Operation tab",
...
const pl: Dict = {
  ...
  "settings.hosts": "Hosty",
  "settings.hosts.help":
    "Zarządzaj stackami na innej maszynie stąd. Wygeneruj token, a następnie uruchom pokazane polecenie na tym hoście — łączy się on jednym wychodzącym WebSocketem (bez portu przychodzącego, bez gniazda Dockera w sieci). Host pojawi się w przełączniku hostów na stronie Stacki.",
  "settings.hosts.mint": "Dodaj hosta",
  "settings.hosts.regenerate": "Wygeneruj nowy token",
  "settings.hosts.revoke": "Odwołaj",
  "settings.hosts.revoked": "Token agenta odwołany.",
  "settings.hosts.active": "Rejestracja jest włączona.",
  "settings.hosts.none": "Brak tokenu agenta.",
  "settings.hosts.copyNow": "Skopiuj token teraz — nie zostanie pokazany ponownie.",
  "settings.hosts.nameLabel": "Nazwa hosta",
  "settings.hosts.runOn": "Uruchom to na hoście, który chcesz dodać:",
  "settings.hosts.copyCmd": "Kopiuj polecenie",
  ...
  "settings.git.remoteTitle": "Zdalne repozytorium git",
  "settings.git.pull": "Pobierz",
  "settings.git.pulling": "Pobieranie…",
  "settings.git.pullDesc":
    "Przewiń katalog stosów do przodu ze zdalnego repozytorium (tylko pobieranie). Zmienione stosy pojawią się jako rozjechane — wdroż je ponownie, aby zastosować.",
  "settings.git.pullFailed": "Pobieranie nie powiodło się.",
  ...
  "stacks.new": "Nowy",
  "stacks.blank": "Pusty",
  "stacks.fromRun": "Z docker run",
  "stacks.runPlaceholder": "Wklej polecenie docker run …",
  "stacks.runPreview": "Wygenerowany compose.yaml",
  "stacks.create": "Utwórz",
  "stacks.deploy": "Wdróż",
  "stacks.pull": "Pobierz",
  ...
  "stacks.logs": "Logi",
  "stacks.operation": "Operacja",
  "stacks.opRunning": "Trwa — wynik w zakładce Operacja",
  "stacks.follow": "Śledź",
...
const de: Dict = {
  ...
  "settings.hosts": "Hosts",
  "settings.hosts.help":
    "Verwalte Stacks auf einem anderen Rechner von hier aus. Erzeuge ein Token und führe den angezeigten Befehl auf diesem Host aus — er verbindet sich über einen einzigen ausgehenden WebSocket (kein eingehender Port, kein Docker-Socket im Netz). Der Host erscheint dann im Host-Umschalter auf der Stacks-Seite.",
  "settings.hosts.mint": "Host hinzufügen",
  "settings.hosts.regenerate": "Token neu erzeugen",
  "settings.hosts.revoke": "Widerrufen",
  "settings.hosts.revoked": "Agent-Token widerrufen.",
  "settings.hosts.active": "Registrierung ist aktiviert.",
  "settings.hosts.none": "Noch kein Agent-Token.",
  "settings.hosts.copyNow": "Kopiere das Token jetzt — es wird nicht erneut angezeigt.",
  "settings.hosts.nameLabel": "Hostname",
  "settings.hosts.runOn": "Führe dies auf dem Host aus, den du hinzufügen möchtest:",
  "settings.hosts.copyCmd": "Befehl kopieren",
  "settings.registries": "Private Registries",
  ...
  "settings.git.remoteTitle": "Git-Remote",
  "settings.git.pull": "Pull",
  "settings.git.pulling": "Wird geholt…",
  "settings.git.pullDesc":
    "Das Stacks-Verzeichnis vom Remote fast-forwarden (nur Pull). Geänderte Stacks werden als abweichend angezeigt — zum Anwenden neu bereitstellen.",
  "settings.git.pullFailed": "Pull fehlgeschlagen.",
  ...
  "stacks.new": "Neu",
  "stacks.blank": "Leer",
  "stacks.fromRun": "Aus docker run",
  "stacks.runPlaceholder": "docker run …-Befehl einfügen",
  "stacks.runPreview": "Generierte compose.yaml",
  "stacks.create": "Erstellen",
  ...
  "stacks.logs": "Logs",
  "stacks.operation": "Operation",
  "stacks.opRunning": "Läuft — Ausgabe im Tab „Operation“",
...
const es: Dict = {
  ...
  "settings.hosts": "Hosts",
  "settings.hosts.help":
    "Gestiona stacks en otra máquina desde aquí. Genera un token y ejecuta el comando mostrado en ese host — se conecta mediante un único WebSocket saliente (sin puerto entrante, sin el socket de Docker en la red). El host aparecerá en el selector de hosts de la página Stacks.",
  "settings.hosts.mint": "Añadir un host",
  "settings.hosts.regenerate": "Regenerar token",
  "settings.hosts.revoke": "Revocar",
  "settings.hosts.revoked": "Token de agente revocado.",
  "settings.hosts.active": "El registro está habilitado.",
  "settings.hosts.none": "Aún no hay token de agente.",
  "settings.hosts.copyNow": "Copia el token ahora — no se volverá a mostrar.",
  "settings.hosts.nameLabel": "Nombre del host",
  "settings.hosts.runOn": "Ejecuta esto en el host que quieres añadir:",
  "settings.hosts.copyCmd": "Copiar comando",
  ...
  "settings.git.remoteTitle": "Remoto de git",
  "settings.git.pull": "Pull",
  "settings.git.pulling": "Actualizando…",
  "settings.git.pullDesc":
    "Avanza rápido el directorio de stacks desde su remoto (solo pull). Los stacks cambiados aparecerán como desviados; vuelve a desplegarlos para aplicar.",
  "settings.git.pullFailed": "Error al hacer pull.",
  ...
  "stacks.new": "Nuevo",
  "stacks.blank": "En blanco",
  "stacks.fromRun": "Desde docker run",
  "stacks.runPlaceholder": "Pega un comando docker run …",
  "stacks.runPreview": "compose.yaml generado",
  "stacks.create": "Crear",
  ...
  "stacks.operation": "Operación",
  "stacks.opRunning": "En curso — salida en la pestaña Operación",
...
const fr: Dict = {
  ...
  "settings.hosts": "Hôtes",
  "settings.hosts.help":
    "Gérez des stacks sur une autre machine depuis ici. Générez un jeton, puis exécutez la commande affichée sur cet hôte — il se connecte via un seul WebSocket sortant (aucun port entrant, pas de socket Docker sur le réseau). L'hôte apparaît ensuite dans le sélecteur d'hôtes de la page Stacks.",
  "settings.hosts.mint": "Ajouter un hôte",
  "settings.hosts.regenerate": "Régénérer le jeton",
  "settings.hosts.revoke": "Révoquer",
  "settings.hosts.revoked": "Jeton d'agent révoqué.",
  "settings.hosts.active": "L'enrôlement est activé.",
  "settings.hosts.none": "Pas encore de jeton d'agent.",
  "settings.hosts.copyNow": "Copiez le jeton maintenant — il ne sera plus affiché.",
  "settings.hosts.nameLabel": "Nom de l'hôte",
  "settings.hosts.runOn": "Exécutez ceci sur l'hôte que vous voulez ajouter :",
  "settings.hosts.copyCmd": "Copier la commande",
  ...
  "settings.git.remoteTitle": "Dépôt distant git",
  "settings.git.pull": "Pull",
  "settings.git.pulling": "Récupération…",
  "settings.git.pullDesc":
    "Fait avancer le répertoire des stacks depuis son distant (pull uniquement). Les stacks modifiées apparaîtront comme divergentes — redéployez-les pour appliquer.",
  "settings.git.pullFailed": "Échec du pull.",
  ...
  "stacks.new": "Nouveau",
  "stacks.blank": "Vierge",
  "stacks.fromRun": "Depuis docker run",
  "stacks.runPlaceholder": "Collez une commande docker run …",
  "stacks.runPreview": "compose.yaml généré",
  "stacks.create": "Créer",
  ...
  "stacks.operation": "Opération",
  "stacks.opRunning": "En cours — sortie dans l'onglet Opération",
